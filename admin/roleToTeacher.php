            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="white-box table-responsive">
                      ...
                      <div id="updateTeacher">
                          <form action="" method="post">
                                ...
                                <select name="teacher" class="form-control" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $rows['teacher_id'];?>" >
                                                ...
                                                <?php echo $rows['teacher_id'].':   '.$rows['name'] ;?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="class" class="form-control" required>
                                    ...
                                    <?php
                                        ...
                                        while($rows = mysqli_fetch_assoc($result)) {
                                    ?>
                                        <option value="<?php echo $rows['standard'];?>" >
                            ...
                            <div class="form-group">
                              ...
                              <button type="submit" name="getSubject" class="btn btn-primary">Get Subjects</button>
                          </form>
                          <br>
                          <br>
                          ...
                          <?php
                            if(isset($_POST['addRole'])){
                              $standard = $_SESSION['class'];
                              $medium = $_SESSION['medium'];
                              $name = $_SESSION['name'];
                                $num = $_POST['check_list'];
                                $i=0;
                                while($i<count($num)){
                                  $a=$num[$i];
                                  $sql6 = "INSERT INTO teacher_teaches VALUES ('$name','$a','$standard','$medium') ";

                                  $i = $i+1;
                                  if(mysqli_query($conn,$sql6)) {
                                      echo "<script>
                                          window.location='roleToTeacher.php';
                                      </script>";
                                  }
                                  else {
                                    
                                      echo '<script>alert("Record Already Exits!")</script>';
                                  }
                              ...
                              $name = $_POST['teacher'];
                              $_SESSION['name'] = $name;
                              $sql = "SELECT subject_id, subject_name FROM subjects WHERE standard='$standard' and medium = '$medium'";
                              $result=mysqli_query($conn,$sql);
                              if(!$result)
                              {
                                  echo "Error ".$sql."<br>".mysqli_error($conn);
                              ...
                              <?php
                              echo "<h3>Select Subjects to assign to &nbsp&nbsp&nbsp Teacher_id:- $name &nbsp&nbsp&nbsp&nbsp Standard:- $standard &nbsp&nbsp&nbsp&nbsp  Medium:- $medium</h3>";
                              ...
                              <td><input type="checkbox" name="check_list[]" value="<?php echo $rows['subject_id']; ?>"></input></td>
                      ...
                      <button type="submit" name="addRole" class="btn btn-primary">Assign Subjects</button>
                      </form>
