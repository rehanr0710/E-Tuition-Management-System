                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box table-responsive">
                            <table class="table">
                                <tr>
                                    <th><h3>Teacher's</h3></th>
                                    <th style="text-align:right;"><button onclick="addTeacher()"  class="btn btn-primary" name="button">Add</button>&nbsp<button onclick="removeTeacher()" class="btn btn-primary" name="button">Remove</button>&nbsp<button onclick="updateTeacher()" class="btn btn-primary" name="button">Update</button></th>
                                </tr>
                            </table>
                            ...
                            <div id="updateTeacher">
                                <form action="" method="post">
                                  <div class="form-group">
                                      <label>Choose Teacher id to Update</label>
                                      <select  class="form-control"  name="teacher_id" required>
                                        <?php
                                            $sql5 = "SELECT teacher_id FROM teachers";
                                ...
                                <?php
                                    if(isset($_POST['updateTeacher'])) {
                                      $teacher_id = $_POST['teacher_id'];
                                        ...
                                        $query = "UPDATE teachers SET name = '$name', mobile_no= '$mobileNo', address= '$address', salary= '$salary', email= '$email', password = '$password' WHERE teacher_id = '$teacher_id';";
                            ...
                            <div id="addTeacher">
                                <form action="" method="post">
                                  <div class="form-group">
                                    ...
                                    <button type="submit" name="addTeacher" class="btn btn-primary">Add</button>
                                </form>
                                ...
                                <?php
                                    if(isset($_POST['addTeacher'])) {
                                        ...
                                        $email = $_POST['eMail'];
                                        $password = $_POST['password'];
                                        $query = "INSERT INTO teachers VALUES(NULL,'$name','$mobileNo','$address','$salary','$email','$password',current_timestamp())";
                                        if(mysqli_query($conn,$query)) {
                                            echo "<script>
                                                window.location='teacher.php';
                                            </script>";
                            ...
                            <div id="removeTeacher">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label>Enter Teacher Id to be removed</label>
                                        <input type="text" name="remove" class="form-control">
                                    </div>
                                    <button type="submit" name="removeTeacher" class="btn btn-primary">Remove</button>
                                </form>

                                <?php
                                    if(isset($_POST['removeTeacher'])) {
                                        $id = $_POST['remove'];
                                        $query1 = "DELETE FROM teachers WHERE teacher_id = '$id'";
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if ($result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) {
                                                echo "<tr><td>" . $row["teacher_id"]. "</td><td>" . $row["name"] . "</td><td>" . $row["mobile_no"] . "</td><td>" . $row["address"] . "</td><td>" . $row["salary"] . "</td><td>" . $row["email"] . "</td></tr>";
                                                }
                                            }
                                ?>
                                    </tbody>
                        ...
                        <script>
                            function addTeacher() {
                                var x = document.getElementById("addTeacher");
                                var y = document.getElementById("removeTeacher");
                                var z = document.getElementById("updateTeacher");
                            ...
                            function removeTeacher() {
                                var x = document.getElementById("removeTeacher");
                                var y = document.getElementById("addTeacher");
                                var z = document.getElementById("updateTeacher");
                                if(y.style.display = "block"){
                                    y.style.display = "none";
                                }
                            ...
                            function updateTeacher() {
                                var x = document.getElementById("updateTeacher");
                                var y = document.getElementById("addTeacher");
                                var z = document.getElementById("removeTeacher");
                                if(y.style.display = "block"){
                                    y.style.display = "none";
                                }
                                if(z.style.display = "block"){
